...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /home/sjtuwhl/ROBOTLAB_WS/src/ros_control-melodic-devel/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /home/sjtuwhl/ROBOTLAB_WS/devel)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sjtuwhl/ROBOTLAB_WS/src/ros_control-melodic-devel/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
