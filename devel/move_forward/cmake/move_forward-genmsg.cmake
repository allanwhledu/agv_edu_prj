...
get_filename_component(_filename "/home/sjtuwhl/ROBOTLAB_WS/src/move_forward/srv/agv_call.srv" NAME_WE)
add_custom_target(_move_forward_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "move_forward" "/home/sjtuwhl/ROBOTLAB_WS/src/move_forward/srv/agv_call.srv" ""
)
...
_generate_srv_cpp(move_forward
  "/home/sjtuwhl/ROBOTLAB_WS/src/move_forward/srv/agv_call.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/move_forward)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/move_forward\")")
  # install generated code
  install(
